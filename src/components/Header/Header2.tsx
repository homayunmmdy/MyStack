...
const Header2 = () => {
  ...
  return (
    <>
          ...
          <div className="navbar-end">
            ...
            >
              <Button
                title="Login"
                color="btn-primary"
                icon={<IoMdLogIn color="white" size={20} />}
              />
            </a>
          </div>
        </div>
      ...
      {isOpen && (
        <nav className="fixed top-[120px] backdrop-blur-md rounded-xl shadow-xl left-[4%] z-[50] w-[300px] border-2 border-indigo-700">
